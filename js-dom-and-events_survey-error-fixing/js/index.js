...
const nextButton = document.querySelector('[data-js="next-button"]'); // replaced "#next" with '[data-js="next-button"]'
...
firstChoiceButton.addEventListener("click", () => {
  ...
  console.log("Selected first choice"); // added .log
});
...
secondChoiceButton.addEventListener("click", () => {
  ...
  secondChoiceButton.classList.add("active-choice"); // replaced .remove with .add
